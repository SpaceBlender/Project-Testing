...
color_location=envDefaltVal('COLOR',None)
...
## hsv_merge.py to use as a texture for the DTM. Creates DTM_TEXTURE.tif
################################################################################
gdal = gdal_driver.GdalDriver(dtm_location, color_location)
gdal.gdal_hillshade()
